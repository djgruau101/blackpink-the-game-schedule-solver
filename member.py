...
class Member(object):
    ...
    __stats_scores = [100, 150, 201, 254, 309,
                      ...
                      1049, 1131, 1215, 1302,
                      1392, 1485, 1581, 1681,
                      1784, 1891]  # the score of a stat is at level (its index + 1)
...
# Member stats: 100, 150, 201, 254, 309, 366, 425, 485, 548, 613, 680, 749, 820, 894, 970, 1049, 1131, 1215, 1302, 1392, 1485, 1581, 1681, 1784, 1891
# Increases: 50, 51, 53, 55, 57, 59, 60, 63, 65, 67, 69, 71, 74, 76, 79, 82, 84, 87, 90, 93, 96, 100, 103, 107